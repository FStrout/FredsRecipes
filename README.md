...
I can't say I prioritized any part over another. I started on the UI, mostly since that's what I did on the last project I worked on; the ui would normally get built in parallel with the api. This was done by using mocks until the backend was ready for integration.
