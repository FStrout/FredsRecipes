//
//  RecipeTileViewModelTests.swift
//  FredsRecipesTests
//
...
struct RecipeTileViewModelTests {
  ...
  @Test func hasNoOutsideLinks() async throws {
    ...
    let viewModel = RecipeTileViewModel(
      recipe: recipes[0],
  ...
  @Test func openURLIsValid() async throws {
    ...
    let viewModel = RecipeTileViewModel(recipe: recipes[0], selectedRecipe: .constant(nil), applicationService: service)
